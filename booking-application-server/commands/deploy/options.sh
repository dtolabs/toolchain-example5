...
# Created: Sat Nov 17 23:31:15 PST 2012
#
#/ usage: booking-application-server:deploy  --jboss-as-package-file <>  --jboss-as-config-package-file <>  --seam-booking-package-file <>  --mysql-connector-java-package-file <> 
