...
if [ -z "$JBOSS_CONF" ]; then
  if [ -r /etc/jboss-as/jboss-as.conf ]
  then
    # There's a system-wide configuration file:
    JBOSS_CONF="/etc/jboss-as/jboss-as.conf"
  else
    # Use the default file included with the package:
    JBOSS_CONF="/usr/share/jboss-as/bin/init.d/jboss-as.conf"
  fi
fi
