...
# Created: Wed Nov 14 14:53:39 PST 2012
#
#/ usage: apache-maven-rpm:build [ --name <apache-maven>] [ --release <1>] [ --version <3.0.4>] 
...
rerun_options_parse() {
    ...
    [ -z "$NAME" ] && NAME="apache-maven"
    [ -z "$RELEASE" ] && RELEASE="1"
    [ -z "$VERSION" ] && VERSION="3.0.4"
